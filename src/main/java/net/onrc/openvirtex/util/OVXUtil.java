...
import org.openflow.protocol.action.OFActionDecap;
import org.openflow.protocol.action.OFActionEncap;
...
public final class OVXUtil {
    ...
    public static Map<String, Object> actionToMap(OFAction act)
        ...
        case OPAQUE_ENQUEUE:
            ...
            break;
        case ENCAP:
        	OFActionEncap enc = (OFActionEncap) act;
        	ret.put("type", "ENCAP");
        	ret.put("encap", enc.getType());
        	break;
        case DECAP:
        	OFActionDecap dec = (OFActionDecap) act;
        	ret.put("type", "DECAP");
        	ret.put("decap", dec.getType());
        case VENDOR:
            ret.put("type", "VENDOR");
            break;
        default:
